...
const getTweets = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const tweets = yield connectDB_1.itemsPool.query(
      "select * from usertweets order by createdAt asc"
    );
...
const getTweet = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tweet = yield connectDB_1.itemsPool.query(
      "select * from userTweets where tweetID=$1",
      [tweetID]
    );
...
const createTweet = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield connectDB_1.itemsPool.query(
...
function getHastags(tweetString) {
  ...
  tweetString.replace(
    checkHashtag,
    "<Link href={https://twitter-backend-rcbd.onrender.com/search/`${}`}>#</Link>"
  );
  return hashTags;
}
...
const postLike = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield connectDB_1.itemsPool.query(
      "update usertweets set likes=likes+1 where tweetid=$1;",
      [id]
    );
    const likesCount = yield connectDB_1.itemsPool.query(
      "select likes from usertweets where tweetid=$1",
      [id]
    );
