...
const storeMessage = (from, to, message) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield connectDB_1.itemsPool.query(
      "insert into chatdata values ($1,$2,$3,$4);",
      [from, to, message, new Date()]
    );
  });
...
const getMessages = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const messages = yield connectDB_1.itemsPool.query(
...
const getUsers = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
      var response = yield connectDB_1.itemsPool.query(
